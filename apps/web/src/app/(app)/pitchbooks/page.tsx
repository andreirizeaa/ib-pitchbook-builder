...
import { Plus, FileText, CheckCircle, Loader2, AlertCircle, Clock, Search } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Pitch Books</h1>
      ...
      {isLoading ? (
        ...
        <div className="grid gap-4">
          {filtered.map((pb) => (
            <Link key={pb.id} href={`/pitchbooks/${pb.id}`}>
