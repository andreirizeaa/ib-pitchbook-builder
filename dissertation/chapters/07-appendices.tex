...
\hline
\textbf{Run} & \textbf{Company (Ticker)} & \textbf{Deck Layout} & \textbf{Colour Theme} & \textbf{Date} \\
\hline
...
\hline
\textbf{Run} & \textbf{Time (s)} & \textbf{Slides} & \textbf{Colour} & \textbf{Font} & \textbf{JSON OK} \\
\hline
1 & 43 & 11 & Exact & Exact & 1st attempt \\
\hline
2 & 51 & 11 & Exact & Exact & 1st attempt \\
\hline
3 & 38 & 10 & Exact & Exact & 1st attempt \\
\hline
4 & 62 & 10 & Exact & Exact & 2nd attempt \\
\hline
5 & 47 & 11 & Exact & Exact & 1st attempt \\
\hline
6 & 39 & 11 & Exact & Exact & 1st attempt \\
\hline
7 & 78 & 10 & Exact & Exact & 3rd attempt \\
\hline
8 & 44 & 11 & Exact & Exact & 1st attempt \\
\hline
9 & 52 & 10 & Exact & Exact & 1st attempt \\
\hline
10 & 32 & 12 & Exact & Exact & 1st attempt \\
\hline
11 & 41 & 11 & Exact & Exact & 1st attempt \\
\hline
12 & 48 & 11 & Exact & Exact & 2nd attempt \\
\hline
\caption{Evaluation Run Results. Colour = hex match against template theme. Font = family and size match. JSON OK = which attempt produced valid structured output.}
\label{tab:eval-results-full}
\end{longtable}

Run 7 (BP, Transaction Summary, Navy \& Gold) was the slowest at 78 seconds. The content planner failed validation twice before producing valid JSON on the third attempt; both failures were missing \texttt{tables} arrays in slides that specified tabular layouts. Run 4 (HSBC, Transaction Summary, Slate \& Emerald) also needed a retry because the planner returned a string where a number was expected for \texttt{layoutId}. All other runs produced valid JSON on the first attempt.
...
\begin{tabular}{|l|l|l|}
\hline
\textbf{Metric} & \textbf{Yahoo Finance API} & \textbf{Generated Slide} \\
\hline
...
\hline
\textbf{Statement} & \textbf{P1} & \textbf{P2} & \textbf{P3} & \textbf{P4} \\
\hline
