...
PPTAgent \parencite{zheng2025} comes closest to what this project needs. Its two-stage approach (analyse reference, generate matching slides) fits IB document generation because it preserves the source deck's visual identity rather than imposing a new one. PPTAgent outperforms earlier systems on both content and design quality using their PPTEval framework.
