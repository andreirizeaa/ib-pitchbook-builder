...
The web app deploys to Vercel on every push to \texttt{main}, and the backend runs on Render. Figures~\ref{fig:vercel-deploy} and~\ref{fig:render-deploy} show both services live.
