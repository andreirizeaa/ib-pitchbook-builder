...
The content planner sends user parameters and the extracted template schema to GPT-4o, requesting a structured content plan. The system prompt (Listing~\ref{lst:system-prompt}) bans generic phrasing and specifies minimum content density per slide type, because early versions produced boilerplate and sparse output.
