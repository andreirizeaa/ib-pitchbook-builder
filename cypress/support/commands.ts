...
Cypress.Commands.add('login', () => {
  const supabaseUrl = 'https://juvptakaojhalkgihzhy.supabase.co';
  const supabaseAnonKey =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp1dnB0YWthb2poYWxrZ2loemh5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI3Mzg3MzAsImV4cCI6MjA4ODMxNDczMH0.hBQNLOGjsfUW2PShWhnSjcFwmbzcyQ2pSvUv_P4LIhw';
  const email = 'cypress-test@pitchdeck.test';
  const password = 'CypressTest1234';
  const ref = 'juvptakaojhalkgihzhy';
